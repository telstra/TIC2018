...
char host[] = "Telstra.azure-devices.net";
char path[] = "/devices/TelstraIoT/messages/events?api-version=2016-02-03";
int port = 443;
//--Unsecure---
...
AzureIoT myAzure("Telstra.azure-devices.net", "TelstraIoT","4ZQ9LD4MZJu4U5DqZVHngJAf9k+lEIudEIahSVw4IWs=",604800);
