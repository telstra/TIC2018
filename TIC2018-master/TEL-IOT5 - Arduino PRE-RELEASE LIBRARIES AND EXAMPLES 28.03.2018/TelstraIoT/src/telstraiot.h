...
private:
    ...
    void Construct(const char* _host, const int _port, const char* _tenantId, const char* _user, const char* _password, const char* _applicationKey, Connection4G* conn, TelstraM1Device* shield);
...
public:
 /**
    ...
    /**
      ...
      *     @param applicationKey - for authorization
      */
    TelstraIoT(const char* host, const char* tenantId, const char* user, const char* password, const char* applicationKey, Connection4G* conn, TelstraM1Device* shield);
    virtual ~TelstraIoT();
